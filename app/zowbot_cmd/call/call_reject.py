...
import time,os
from core.layers.protocol_calls.protocolentities.call_reject import RejectCallProtocolEntity
...
class Cmd_Call_Reject(BotCommand):
    ...
    async def execute(self, params, options):
        ...
        callEntity = RejectCallProtocolEntity(            
            callId=params[1],
